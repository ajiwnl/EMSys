    ...
    public class SubjectController : Controller
    {
        ...
        public IActionResult Add(Subject addRequestSubject)
        {
            try
            {
                ...
                // Check if a requisite type is selected
                ...
                // Check for duplicate subjects in a same course code
                ...
                {
                    // When the prerequisite type is "CO," set SUBJCODEPREQ to "n/a"
                    addRequestSubject.SUBJCODEPREQ = "n/a";
                }

                // Check if the Subject Pre-requisite Code is empty or not for "PREQ" and "PRE"
                ...
                // Check if the Subject Pre-requisite Code is empty or not for "PRE"
                if (addRequestSubject.SUBJPREQ == "PRE")
                {
                    ...
                    // Check if the 'SUBJCODEPREQ' exists for the same course code
            ...
            {
                // Handle other database execptions
        ...
        //-----------------------------------------------Functions---------------------------------------------------------     
        //Function for Empty Fields Validations
